...
//+kubebuilder:webhook:path=/validate-dbaas-redhat-com-v1alpha2-rdsinventory,mutating=false,failurePolicy=fail,sideEffects=None,groups=dbaas.redhat.com,resources=rdsinventories,verbs=create,versions=v1alpha2,name=vrdsinventory.kb.io,admissionReviewVersions=v1
